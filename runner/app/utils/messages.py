...
class GameInfoMessage(BaseModel):
    ...
    left_team_config_json: Optional[str] = Field(None,
                                                 example='{"left_team_config_json": "{\"version\":1, \"formation_name\":\"433l\"}"}')
    right_team_config_json: Optional[str] = Field(None,
                                                  example='{"right_team_config_json": "{\"version\":1, \"formation_name\":\"433l\"}"}')
...
class TeamMessage(BaseModel):
    ...
    team_config_json: Optional[str] = Field(None,
                                            example='{"team_config_json": "{\"version\":1, \"formation_name\":\"433l\"}"}')
...
class AddTournamentRequestMessage(BaseMessage):
    ...
    user_id: int = Field(None, example=1)
    teams: list[TeamMessage] = Field(None, example=[{"user_id": 1, "team_name": "team1",
                                                     "team_config_json": '{"team_config_json": "{\"version\":1, \"formation_name\":\"433l\"}"}',
